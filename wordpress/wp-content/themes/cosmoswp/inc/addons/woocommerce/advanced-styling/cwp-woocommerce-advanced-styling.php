...
.cwp-woocommerce-active span.wc-block-grid__product-onsale:after{
    ...
    background-color:' . $toolbar_bg_color . '!important;
			...
			if ( ! empty( $grid_list_color ) ) {
				$grid_list_color_css    = '.cwp-woo-archive-toolbar .cwp-woo-view-switcher span{
    ...
    border-color:' . $grid_list_color . '!important;
			...
			if ( ! empty( $grid_list_hover_color ) ) {
				$grid_list_color_hover_css = '.cwp-woo-archive-toolbar .cwp-woo-view-switcher span.active,
.cwp-woo-archive-toolbar .cwp-woo-view-switcher span:hover{
