...
wp.customize.controlConstructor['cosmoswp-responsive-buttonset'] =
    wp.customize.Control.extend({
        ...
        updateValue: function () {
            ...
            var valueToPush = {};
            control.container
                .find('.cosmoswp-responsive-buttonset-device-wrap')
                .each(function () {
                    var $ = jQuery;
            ...
            var collector = jQuery(control).find(
                '.cosmoswp-responsive-buttonset-collection-value'
            );
 ...
 * File responsive.js
 */
wp.customize.controlConstructor['responsive-range'] =
    wp.customize.Control.extend({
        ...
        ready: function () {
            ...
            this.container.on(
                'change keyup input',
                'input.responsive-range--input, select.responsive-range--select',
                function () {
                    control.updateValue();
                }
            );
        ...
        resetValues: function () {
            ...
            this.container.find('.responsive-range--select').each(function () {
                ...
                jQuery(this)
                    .find('option[value=' + jQuery(this).data('default') + ']')
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        function refresh_group_values(control_wrap) {
            ...
            control_wrap
                .next('.cosmoswp-group-collection')
                .val(JSON.stringify(valueToPush))
                .trigger('change');
        }
        ...
        customize_theme_controls.on(
            ...
            function () {
                var this_field_title = $(this),
                    group_field_control = this_field_title.closest(
                        '.group-field-control'
                    );
                ...
                group_field_control
                    .find('.group-fields')
                    .trigger('cosmoswp_group_slide_toggle');
            }
        );
        ...
        function cosmoswp_group_field_border_style_control(group_field) {
            ...
            if (select_data_attr === 'border-style') {
                ...
                if (selected_val === 'none') {
                    selectParent
                        .siblings()
                        .find('.responsive-switchers-cssboxfields')
                        .each(function () {
                    ...
                    selectParent
                        .siblings()
                        .find('.customize-control-alpha-color')
                        .each(function () {
        ...
        customize_theme_controls
            .find('.group-field-control-wrap select[data-single-name]')
            .each(function () {
                cosmoswp_group_field_border_style_control($(this));
            });
        ...
        customize_theme_controls
            .find('.group-field-control-wrap input[type="checkbox"]')
            .each(function () {
                cosmoswp_group_field_check_overlay_color_control($(this));
            });
 ...
 * Multicheck JS
 * */
wp.customize.controlConstructor['cosmoswp-multicheck'] =
    wp.customize.Control.extend({
        // When we're finished loading continue processing.
        ready: function () {
            'use strict';
            ...
            control.container.on('change', 'input', function () {
                ...
                jQuery.each(control.params.choices, function (key, subValue) {
                    if (
                        control.container.find('input[value="' + key + '"]').is(':checked')
                    ) {
                        value[i] = key;
                        i++;
                    }
    ...
    wp.customize.Control.extend({
        ready: function () {
            ...
            this.container.on('click', '.accordion-section-title', function (e) {
                ...
                var this_field_title = $(this),
                    repeater_field_control = this_field_title.closest(
            ...
            this.container.on(
                'click',
                '.cosmoswp-repeater-add-control-field',
                function () {
                    var $ = jQuery;
                    var $this = $(this).parent();
                    if (typeof $this !== 'undefined') {
                        var field = $this
                            .find('.cosmoswp-repeater-field-control-generator')
                            .html();
                        field = $($.parseHTML(field));
                        if (typeof field !== 'undefined') {
                            field
                                .find("input[type='text'][data-single-name]")
                                .each(function () {
            ...
            this.container.on('click', '.repeater-field-remove', function () {
                ...
                if (typeof $(this).parent() !== 'undefined') {
                    $(this)
                        .closest('.repeater-field-control')
            ...
            this.container
                .find(
                    '.cosmoswp-repeater-field-control-wrap .contact-link-type select[data-single-name]'
                )
                .change(function () {
                    var $ = jQuery;
                    if ($(this).val() === 'disable') {
                        ...
                        $(this)
                            .parent()
                            .siblings('.contact-url')
                            .addClass('cosmoswp-hide-element');
                        $(this)
                            .parent()
                            .siblings('.contact-checkbox')
                            .addClass('cosmoswp-hide-element');
                    } else {
                        $(this)
                            .parent()
                            .siblings('.contact-url')
                            .removeClass('cosmoswp-hide-element');
                        $(this)
                            .parent()
                            .siblings('.contact-checkbox')
                            .removeClass('cosmoswp-hide-element');
    ...
    wp.customize.Control.extend({
        ready: function () {
            ...
            var control = this,
                ...
                desktop_slider = control_container.find(
                    '.cosmoswp-slider.desktop-slider'
                ),
                desktop_slider_input = desktop_slider
                    .next('.cosmoswp-slider-input')
                    .find('input.desktop-input'),
                tablet_slider = control_container.find(
                    '.cosmoswp-slider.tablet-slider'
                ),
                tablet_slider_input = tablet_slider
                    .next('.cosmoswp-slider-input')
                    .find('input.tablet-input'),
                mobile_slider = control_container.find(
                    '.cosmoswp-slider.mobile-slider'
                ),
    ...
    $(document).ready(function () {
        ...
        function select_parent_type_result(mode, parent, selected_val) {
            if (selected_val === 'none') {
                parent
                    .siblings()
                    .find('.customize-control-cosmoswp-cssbox')
                    .each(function () {
        ...
        customize_theme_controls.on(
            'keyup change',
            '.tabs-field-control-wrap [data-single-name], .tabs-field-control-wrap .responsive-range, .tabscssbox-field',
            function (e) {
                e.preventDefault();
        ...
        customize_theme_controls.on(
            'change',
            '.tabs-field-control-wrap select[data-single-name]',
            function () {
        ...
        customize_theme_controls
            .find('.tabs-field-control-wrap select[data-single-name]')
            .each(function () {
                cosmoswp_tab_field_border_style_control($(this));
            });
        ...
        $('.tabs-field-control').on('click', '.tab-trigger', function () {
            ...
            tabs_field_control
                .find('.fields-tabs-content.' + tab_trigger.data('id'))
                .addClass('active');
        });
    });
})(jQuery);
...
jQuery(document).ready(function ($) {
    ...
    customize_theme_controls.on(
        'click',
        '.customize-icons .icon-toggle ,.customize-icons .icon-preview',
        function () {
            ...
            if (icons_list_wrapper.is(':hidden')) {
                icons_list_wrapper.slideDown(500, function () {
    ...
    var backgound_image = $(
        '.customize-control-group .single-field.type-image .img-preview-wrap > img'
    );
    ...
    function load_default_font_weight(parent_group_fields) {
        var select_font_weight = parent_group_fields.find(
            "select[data-single-name='font-weight']"
        ),
                        ...
                        $.ajax({
                            ...
                            .done(function (data) {
                                if (data.success) {
                                    ...
                                    select_google_font.empty().append(options_html);
                                    google_fonts_loader.addClass('cwp-google-fonts-loaded');
                                    load_google_font_weight(
                                        parent_group_fields,
                                        selected_google_font
                                    );
                                }
                            })
    ...
    $('.group-fields').on('cosmoswp_group_slide_toggle', function () {
        var parent_group_fields = $(this),
            this_val = parent_group_fields
                .find("select[data-single-name='font-type']")
                .val();
    ...
    $("select[data-single-name='google-font']").on(
        'change rightnow',
        function () {
            var this_font = $(this),
                this_val = this_font.val(),
