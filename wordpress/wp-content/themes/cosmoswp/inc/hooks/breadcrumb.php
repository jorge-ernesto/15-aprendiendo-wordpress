		...
		if ( 'disable' != $breadcrumb_options ) {
			if ( ! is_front_page() ) {
				...
				if ( function_exists( 'yoast_breadcrumb' ) && 'yoast' == $breadcrumb_options ) {
					...
					yoast_breadcrumb();
					echo '</div></div>';
				} elseif ( function_exists( 'rank_math' ) && 'rank-math' == $breadcrumb_options && rank_math()->settings->get( 'general.breadcrumbs' ) ) {
					echo "<div class='breadcrumbs'><div id='cwp-breadcrumbs' class='cwp-breadcrumbs'>";
					rank_math_the_breadcrumbs();
					echo '</div></div>';
				} elseif ( function_exists( 'bcn_display' ) && 'bcn' == $breadcrumb_options ) {
					echo "<div class='breadcrumbs'><div id='cwp-breadcrumbs' class='cwp-breadcrumbs'>";
					bcn_display();
					echo '</div></div>';
				} elseif ( class_exists( 'WooCommerce' ) && 'woocommerce' == $breadcrumb_options ) {
					echo "<div class='breadcrumbs'><div id='cwp-breadcrumbs' class='cwp-breadcrumbs'>";
